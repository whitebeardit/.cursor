...
**IMPORTANT**: This subagent MUST use the `opentelemetry-instrumentation` skill located at `.cursor/skills/dotnet/opentelemetry-instrumentation/SKILL.md`

**Before performing any instrumentation tasks:**
1. Read the skill file: `.cursor/skills/dotnet/opentelemetry-instrumentation/SKILL.md`
