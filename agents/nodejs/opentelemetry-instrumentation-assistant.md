---
name: opentelemetry-instrumentation-assistant
model: inherit
...
**IMPORTANT**: This subagent MUST use the `opentelemetry-instrumentation` skill located at `.cursor/skills/nodejs/opentelemetry-instrumentation/SKILL.md`

**Before performing any instrumentation tasks:**
1. Read the skill file: `.cursor/skills/nodejs/opentelemetry-instrumentation/SKILL.md`
