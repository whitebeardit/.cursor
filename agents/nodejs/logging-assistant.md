...
**IMPORTANT**: This subagent MUST use the `correlation-id-tracking` skill located at `.cursor/skills/nodejs/correlation-id-tracking/SKILL.md`

**Before performing any logging tasks:**
1. Read the skill file: `.cursor/skills/nodejs/correlation-id-tracking/SKILL.md`
